...
class MyService(rpyc.Service):
    def on_connect(self, conn):
        ...
        if self.__connected is False:
            ...
            while True:
                ...
                break
            print "Initialized!"
            self.__hndcam = hndcam.HndCam(rgtcamid = 0, lftcamid = 1)
    ...
    def exposed_getpcdarray(self, picklemat_tw=None):
        """
        get the full poind cloud of a new frame s an array
    ...
    def exposed_getrcimg(self):
        ...
        return pickle.dumps(self.__hndcam.rgtcap.read()[1])

    def exposed_getlcimg(self):
        """
        ...
        return pickle.dumps(self.__hndcam.lftcap.read()[1])

if __name__ == "__main__":
    server = ThreadedServer(MyService, hostname="10.2.0.60", port = 18291)
    server.start()