...
This file is designed to perform cd using mesh models
Correspondingly, the collisioncheckerball file is deisnged to perform cd using balls

This file needs an extra genmnp_list implementation in the robotmesh file
