...
def jacobian(ur5dualrobot, armname="rgt"):
    """
...
def manipulability(ur5dualrobot, armname="rgt"):
    """
...
def tcperror(ur5dualrobot, tgtpos, tgtrot, armname="rgt"):
    """
...
def numikr(ur5dualrobot, tgtpos, tgtrot, armname="rgt"):
    """
    ...
    armjnts = numik(ur5dualrobot, tgtpos, tgtrot, armname)
...
def numikreltcp(ur5dualrobot, deltax, deltay, deltaz, armname = 'rgt'):
    """
    ...
    return numik(ur5dualrobot, newtgtpos, tgtrot, armname)
