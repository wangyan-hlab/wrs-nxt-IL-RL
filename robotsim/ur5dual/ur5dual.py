...
class Ur5DualRobot():
    ...
    def numik(self, objpos, objrot, armname="rgt"):
        return ur5dualik.numik(self, objpos, objrot, armname)

    def numikr(self, objpos, objrot, armname="rgt"):
        return ur5dualik.numikr(self, objpos, objrot, armname)
...
if __name__=="__main__":
    ...
    armname="rgt"
    armname="lft"
    # armjntsgoal = hrp5robot.numikr(objpos, objrot, armname)
    # if armjntsgoal is not None:
    #     hrp5robot.movearmfkr(armjntsgoal, armname)
    #     hrp5plot.plotstick(base.render, hrp5robot)
    #     hrp5mnp = hrp5plot.genHrp5mnp(hrp5robot)
    #     hrp5mnp.reparentTo(base.render)
    armjntsgoal = ur5dualrobot.numik(objpos, objrot, armname)
    if armjntsgoal is not None:
