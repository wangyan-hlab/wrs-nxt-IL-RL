...
if __name__=='__main__':
    ...
    freegriptst.planGrasps(base, discretesize=15)
    ...
    # data = gdb.loadFreeAirGrip('LShape', 'rtq85')
    # data = gdb.loadFreeAirGrip('LwB', 'sck918')
    # data = gdb.loadFreeAirGrip('new_LSHAPE', 'sck918')
    # data = gdb.loadFreeAirGrip('candy', 'sck918')
    data = gdb.loadFreeAirGrip('twostairpeg_handle', 'sck918')
    if data:
        ...
        for i, freegriprotmat in enumerate(freegriprotmats):
            ...
            sckhnd.setMat(pandanpmat4=freegriprotmat)
            # rtqhnd.setJawwidth(freegripjawwidth[i])
            sckhnd.setJawwidth(freegripjawwidth[i])
            # pandamat4 = rtqhnd.handnp.getMat()
            pandamat4 = sckhnd.handnp.getMat()
