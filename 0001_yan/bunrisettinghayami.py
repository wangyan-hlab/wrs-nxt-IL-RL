...
class Env(object):
    ...
    def __init__(self, betransparent=False):
        ...
        # table
        self.__tablepath = os.path.join(self.__this_dir, "obstacles", "ur3dtablehayamiassembly.stl")
        ...
        # fixture
        self.__assfixturepath = os.path.join(self.__this_dir, "obstacles", "ur3dassfixture.stl")
        self.__assfixturecm = cm.CollisionModel(self.__assfixturepath)
        self.__assfixturecm.setColor(.4, .4, .6, 1.0)
        self.__assfixturecm.setPos(395.0, -285.0, 1000.0)
    ...
    def reparentTo(self, nodepath):
        if not self.__battached:
            ...
            # fixture
            self.__assfixturecm.reparentTo(nodepath)
