...
class NxtDTCtl(object):
    ...
    def rgtcapture(self):
        ...
        posG = base.pg.npToMat4(np.array([[0, 1, 0], [0, 0, -1], [-1, 0, 0]]),
                                np.array([595, 0, 973 - 76 + 75 + 80]))

        goalTlist = []
        # plannedpath = readfile("Planned_tenonpath_deriv1.txt")
        plannedpath = readfile("Planned_tenonpath_deriv2.txt")
    ...
    def rgtcapturestart(self):
        ...
        # virtualgoalrot0 = rm.rodrigues([0, 0, 1,], 0)
    ...
    def plannplay(self, transitoption = "useboth", choice = "startrgtgoalrgt"):
        ...
        def updatesection(objmsmpactive, numikrmsmpactive, jawwidthmpactive, objmsmp, numikrmsmp, jawwidthmp, rbtmnp,
            ...
            if base.inputmgr.keyMap['space'] is True or (motionseccounter[0] > 2 and not taskMgr.hasTaskNamed("updatemotionsec")):
                        ...
                        if len(jntslist_rgt) == 2:
                            ...
                            for n in range(length):
                                ...
                                if jntslist_rgt_rad:
                                    ...
                                    rightangles = [math.radians(15), 0, math.radians(-143), 0, 0, 0]
                                    for rightangle in rightangles:
                                        angle.append(rightangle)
...
if __name__=="__main__":
    base = pc.World(camp=[400,0,3000], lookatp=[400,0,1000], up = [0,0,1], fov = 40, w = 1920, h = 1080)
    # objname = "housing.stl"
    # objname = "box.stl"
