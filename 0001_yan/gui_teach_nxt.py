...
class NxtDTCtl(object):
    ...
    def rgtcapture(self):
        ...
        virtualgoalpos0 = np.array([480,0,973-76+20])
        # virtualgoalpos0 = np.array([411.1019717, 35.5580277, 171.410572+973])
        virtualgoalrot0 = rm.rodrigues([0,1,0,], 0)
        virtualgoalpos1 = np.array([350,0,973-76+20])
        # virtualgoalpos1 = np.array([411.1019717, 35.5580277, 171.410572+973])
        virtualgoalrot1 = rm.rodrigues([0,1,0,], 0)
        virtualgoalpos2 = np.array([400,0,973-76+20])
        # virtualgoalpos2 = np.array([411.1019717, 35.5580277, 171.410572+973])
        virtualgoalrot2 = rm.rodrigues([0,1,0,], 0)
        virtualgoalpos3 = np.array([490,350,1200])
        # virtualgoalpos3 = np.array([449.8844313, 34.9884457, 76.7129198+973])
    ...
    def rgtcapturestart(self):
        ...
        virtualgoalpos0 = np.array([300,-200,973-76])
        # virtualgoalpos0 = np.array([411.2619717, 35.5580277, 171.450572+973])
        virtualgoalrot0 = rm.rodrigues([0,1,0,], 0)
