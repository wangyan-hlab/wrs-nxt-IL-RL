...
class NxtDTCtl(object):
    ...
    def restart(self):
        ...
        # uncomment the following commands to actuate the robot
        # self.nxtu.setJointAnglesOfGroup('torso', 0.0, 5.0, True)
        # self.nxtu.setJointAnglesOfGroup('rarm', self.robot.initjnts[3:9], 5.0, True)
        # self.nxtu.setJointAnglesOfGroup('larm', self.robot.initjnts[9:15], 5.0, True)
    ...
    def rgtcapture(self):
        ...
        virtualgoalpos0 = np.array([411.2619717, -161.958744, 171.450572+973])
    ...
    def rgtcapturestart(self):
        ...
        virtualgoalpos0 = np.array([411.2619717, -161.958744, 65.9594187+973])
        virtualgoalrot0 = rm.rodrigues([0,1,0,], -90)
