...
if __name__ == '__main__':
    ...
    # -------------- ROTATE THE ROBOT ------------------- #
    rot_angles = readfile("Planned_Lpath_deriv2_robot.txt", 36, 53)
    ...
    close_angles = readfile("Planned_Lpath_deriv2_robot.txt", 53, 65)
    ...
    insert_angles = readfile("Planned_Lpath_deriv2_robot.txt", 65, 282)
