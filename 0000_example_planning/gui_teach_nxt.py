...
from robotcon.rpc.hndcam import cameras
...
class NxtDTCtl(object):
    ...
    def plannplay(self, transitoption = "useboth", choice = "startrgtgoallft"):
        ...
        for id in range(1, len(self.goallist)-1):
            ...
            regrip.reset()
            regrip.addStartGoal(startrotmat4 = startrotmat4, goalrotmat4 = goalrotmat4, choice = "startrgtgoallft",
