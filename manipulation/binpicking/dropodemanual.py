...
import random
import time
import manipulation.binpicking.gripper as gripper
...
class ODESim(object):
    ...
    def __init__(self, base, objpath, nobj = 5):
        ...
        # test
        # self.pggen = base.pggen.PandaGeomGen()
        # self.handlen = 50.0
        #
        # # palm, no geom
        ...
        # # linear joint between palm and obstacles
        ...
        # base.pggen.plotAxisSelf(self.base.render)
    ...
    def addGround(self):
        ...
        boxy = 500.0
        boxz = 1.0
        base.pggen.plotBox(self.base.render, pos = [0,0,-1.0], x = boxx*2.0, y = boxy*2.0, z = boxz*2.0, rgba=None)
