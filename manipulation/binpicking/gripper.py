...
class Gripper(object):
    ...
    def __init__(self, base, odespace, odeworld, fgrlen = 50.0, handwidth = 20.0):
        ...
        self.palmgeom = base.pggen.genBox(10.0, 10.0, 2.0)
        ...
        self.fgr0geom = base.pggen.genBox(10.0, 2.0, self.handlen)
        ...
        self.fgr1geom = base.pggen.genBox(10.0, 2.0, self.handlen)
...
if __name__=='__main__':
    ...
    base.pggen.plotAxis(base.render, length = 10, thickness = 1)
