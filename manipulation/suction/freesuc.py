...
class Freesuc(object):
    ...
    def loadObjModel(self, ompath):
        ...
        # oversegmentation
        self.facets, self.facetnormals, self.facetcurvatures = self.objtrimesh.facets_over(faceangle=.95)
        self.facetcolorarray = pandageom.randomColorArray(self.facets.shape[0])
        self.sampleObjModel()
        # prepare the model for collision detection
        self.objgeom = base.pg.packpandageom_fn(self.objtrimesh.vertices, self.objtrimesh.face_normals, self.objtrimesh.faces)
...
if __name__=='__main__':
    ...
    objnp = base.pg.packpandanp_fn(freesuctst.objtrimesh.vertices,
