...
# sqdescriber2 do not move an arm back to its initial pose after handover
        ...
        if i == 0 and len(pathnidlist) == 2:
            ...
            if nid.startswith('startrgt'):
                if((type is "OC") or (type is "OO")):
                    numikrlist.append([armjntsgrphanda[0], armjntsgrphanda[1], numikrlist[-1][2]])
                    numikrlist.append([armjntsgrp[0], armjntsgrp[1], numikrlist[-1][2]])
                    jawwidth.append([regrip.robothand.jawwidthopen, jawwidth[-1][1]])
                    jawwidth.append([regrip.robothand.jawwidthopen, jawwidth[-1][1]])
                numikrlist.append([armjntsgrp[0], armjntsgrp[1], numikrlist[-1][2]])
                numikrlist.append([armjntsgrpworlda[0], armjntsgrpworlda[1], numikrlist[-1][2]])
                jawwidth.append([gripjawwidth, jawwidth[-1][1]])
                jawwidth.append([gripjawwidth, jawwidth[-1][1]])
            if nid.startswith('startlft'):
                if((type is "OC") or (type is "OO")):
                    numikrlist.append([armjntsgrphanda[0], numikrlist[-1][1], armjntsgrphanda[1]])
                    numikrlist.append([armjntsgrp[0], numikrlist[-1][1], armjntsgrp[1]])
                    jawwidth.append([jawwidth[-1][0], regrip.robothand.jawwidthopen])
                    jawwidth.append([jawwidth[-1][0], regrip.robothand.jawwidthopen])
                numikrlist.append([armjntsgrp[0], numikrlist[-1][1], armjntsgrp[1]])
                numikrlist.append([armjntsgrpworlda[0], numikrlist[-1][1], armjntsgrpworlda[1]])
            ...
            # if handovertransit
                ...
                if nid0.startswith('horgt'):
                    numikrlist.append([armjntsgrp0[0], armjntsgrp0[1], numikrlist[-1][2]])
                    jawwidth.append([grpjawwidth0, regrip.robothand.jawwidthopen])
                elif nid0.startswith('holft'):
                    numikrlist.append([armjntsgrp0[0], numikrlist[-1][1], armjntsgrp0[1]])
                ...
                if nid1.startswith('horgt'):
                    numikrlist.append([armjntsgrphanda1[0], armjntsgrphanda1[1], armjntsgrp0[1]])
                    numikrlist.append([armjntsgrp1[0], armjntsgrp1[1], armjntsgrp0[1]])
                    numikrlist.append([armjntsgrp1[0], armjntsgrp1[1], armjntsgrp0[1]])
                    jawwidth.append([regrip.robothand.jawwidthopen, grpjawwidth0])
                    jawwidth.append([regrip.robothand.jawwidthopen, grpjawwidth0])
                    jawwidth.append([grpjawwidth1, grpjawwidth0])
                elif nid1.startswith('holft'):
                    numikrlist.append([armjntsgrphanda1[0], armjntsgrp0[1], armjntsgrphanda1[1]])
                    numikrlist.append([armjntsgrp1[0], armjntsgrp0[1], armjntsgrp1[1]])
                    numikrlist.append([armjntsgrp1[0], armjntsgrp0[1], armjntsgrp1[1]])
                    jawwidth.append([grpjawwidth0, regrip.robothand.jawwidthopen])
                    jawwidth.append([grpjawwidth0, regrip.robothand.jawwidthopen])
                ...
                # choice
                if nid0.startswith('horgt'):
                    numikrlist.append([armjntsgrp0[0], armjntsgrp0[1], armjntsgrp1[1]])
                    numikrlist.append([armjntsgrpb[0], armjntsgrpb[1], armjntsgrp1[1]])
                    jawwidth.append([regrip.robothand.jawwidthopen, grpjawwidth1])
                    jawwidth.append([regrip.robothand.jawwidthopen, grpjawwidth1])
                elif nid0.startswith('holft'):
                    numikrlist.append([armjntsgrp0[0], armjntsgrp1[1], armjntsgrp0[1]])
                    numikrlist.append([armjntsgrpb[0], armjntsgrp1[1], armjntsgrpb[1]])
