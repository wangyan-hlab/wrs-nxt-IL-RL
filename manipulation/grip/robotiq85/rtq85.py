...
class Rtq85():
    ...
    def __init__(self, jawwidth=85, ftsensoroffset = 52):
        ...
        rtq85base.setMat(base.pg.npToMat4(rm.rodrigues([1,0,0], 90))*rtq85base.getMat())
...
if __name__=='__main__':
    ...
    rtq85hnd = Rtq85(ftsensoroffset=0)
    rtq85hnd.setJawwidth(70)
    rtq85hnd.gripAt(0,0,0,1,0,0,30)
    rtq85hnd.reparentTo(base.render)
    base.pggen.plotAxis(base.render)
    rmathnd = rtq85hnd.getMat()
    base.pggen.plotAxis(base.render, spos = rmathnd.getRow3(3), pandamat3 = rmathnd)
    base.run()
