...
class Sck918(object):
    ...
    def __init__(self, jawwidth=50, hndcolor=None, ftsensoroffset = 52):
        ...
        if hndcolor is None:
            ...
            sck918base.setColor(hndcolor[0], hndcolor[1], hndcolor[2], hndcolor[3])
    ...
    def setMat(self, pandanpmat4):
        ...
        self.sck918np.setMat(pandanpmat4)
    ...
    def gripAt(self, fcx, fcy, fcz, c0nx, c0ny, c0nz, rotangle = 0, jawwidth = 50):
        ...
        self.sck918np.setMat(handmat4*Mat4.rotateMat(0.0, handmat4.getRow3(2)))
...
def newHandNM(jawwidth=50, hndcolor=None, ftsensoroffset = 52):
    return Sck918(jawwidth, hndcolor, ftsensoroffset)
...
if __name__=='__main__':
    ...
    sck918hnd.gripAt(0,0,0,0,1,1,0)
