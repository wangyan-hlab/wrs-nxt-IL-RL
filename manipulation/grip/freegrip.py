...
from pandaplotutils import collisiondetection as cd
...
if __name__=='__main__':
    ...
    # objpath = os.path.join(this_dir, "objects", "planerearstay21.stl")
    # objpath = os.path.join(this_dir, "objects", "housing.stl")
    objpath = os.path.join(this_dir, "objects", "tool_suctionscrewdriver.stl")

    handpkg = rtq85nm
    freegriptst = Freegrip(objpath, handpkg, readser=False)
    ...
    # data = gdb.loadFreeAirGrip('planewheel', 'rtq85')
    # if data:
